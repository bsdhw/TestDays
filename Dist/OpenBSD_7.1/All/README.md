...
|---------------------------------|-----------|---------|
| NVMe Samsung SSD 980 2TB        | 4         | 3.13%   |
...
| USB SanDisk 3.2Gen1 64GB        | 1         | 0.78%   |
...
|------------|-----------|--------|---------|
| 0.01-0.5   | 63        | 79     | 60.58%  |
| 0.51-1.0   | 27        | 33     | 25.96%  |
| 1.01-2.0   | 8         | 16     | 7.69%   |
| 3.01-4.0   | 5         | 9      | 4.81%   |
| 4.01-10.0  | 1         | 3      | 0.96%   |
...
| Model                                                                                  | Computers | Percent |
|----------------------------------------------------------------------------------------|-----------|---------|
| Intel 400 Series Chipset Family SATA AHCI Controller                                   | 6         | 5.17%   |
| AMD FCH SATA Controller [AHCI mode]                                                    | 6         | 5.17%   |
| Intel 82801G (ICH7 Family) IDE Controller                                              | 5         | 4.31%   |
...
| Intel 6 Series/C200 Series Chipset Family Mobile SATA Controller (IDE mode, ports 4-5) | 2         | 1.72%   |
| Intel 6 Series/C200 Series Chipset Family Mobile SATA Controller (IDE mode, ports 0-3) | 2         | 1.72%   |
...
| Lenovo unknown                                                                         | 1         | 0.86%   |
| KIOXIA NVMe SSD Controller BG4                                                         | 1         | 0.86%   |
| KIOXIA NVMe SSD                                                                        | 1         | 0.86%   |
...
|-----------------------------------|-----------|---------|
| Intel                             | 49        | 42.24%  |
| Realtek Semiconductor             | 43        | 37.07%  |
...
| Intel Ultimate N WiFi Link 5300                                             | 4         | 2.68%   |
| Intel 82574L Gigabit Network Connection                                     | 4         | 2.68%   |
| Intel 82567LM Gigabit Network Connection                                    | 4         | 2.68%   |
| Realtek RTL810xE PCI Express Fast Ethernet controller                       | 3         | 2.01%   |
| Qualcomm Atheros AR9271 802.11n                                             | 3         | 2.01%   |
...
| Ericsson Business Mobile Networks F5521 gw Mobile Broadband Serial Port III | 2         | 1.34%   |
